...
static void OnJoinRequest(LmHandlerJoinParams_t *joinParams)
{
  /* USER CODE BEGIN OnJoinRequest_1 */
	LmHandlerFlagStatus_t ret = LmHandlerJoinStatus();
	if(ret)
	{
		MW_LOG(TS_OFF, VLEVEL_M, "OnJoinRequest: JOINED OK\r\n");
	}
	else
	{
		MW_LOG(TS_OFF, VLEVEL_M, "OnJoinRequest: NOT JOINED\r\n");
	}
